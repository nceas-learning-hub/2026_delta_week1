...
[Full Screen](slides/craft_synthesis_ideas/slides1_four_player_model.html){target="_blank"}

```{=html}
<iframe class="slide-deck" src="slides/craft_synthesis_ideas/slides1_four_player_model.html" style="border: 1px solid #2e3846;"></iframe>
```
