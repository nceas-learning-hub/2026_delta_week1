...
![](images/proj_mgmt_team_science/github-project.png){fig-alt="a series of vertical boards labelled back burner, inqueue, active progress, waiting, and done, with cards for specific tasks and individuals and due dates assigned" .lightbox}
