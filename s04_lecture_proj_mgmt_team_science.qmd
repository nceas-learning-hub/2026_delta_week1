...
<p align="center">
<img src="images/proj_mgmt_team_science/mind-map.png" alt="Bubble with a central concept or question, surrounded, at the first level, by inputs, outputs or modifiers and at the second level by question, concerns, or implications" width="90%"/>
</p>
...
<p align="center">
<img src="images/proj_mgmt_team_science/feasibility-matrix.png" alt="x and y axes, labelled with novelty/importance (Y) and feasibility (x), with project ideas distributed across the resulting space" width="90%"/>
</p>
...
<p align="center">
<img src="images/proj_mgmt_team_science/analysis-flow.png" alt="rectangular boxes containing data sources (Si concentration, streamflow, watershed geometry and land use, watershed precipitation), linked to diamond-shaped boxed describing processing steps, linked to more rectangles with outputs" width="90%"/>
...
<p align="center">
<img src="images/proj_mgmt_team_science/gantt-image.png" alt="a series of overlapping horizontal colored bars represents the active work periods for several critical project tasks" width="100%"/>
</p>
...
<p align="center">
<img src="images/proj_mgmt_team_science/github-project.png" alt="a series of vertical boards labelled back burner, inqueue, active progress, waiting, and done, with cards for specific tasks and individuals and due dates assigned" width="100%"/>
...
<p align="center">
<img src="images/proj_mgmt_team_science/github-gantt.png" alt="a series of overlapping horizontal colored bars represents the active work periods for several critical project tasks" width="100%"/>
