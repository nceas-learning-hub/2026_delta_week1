...
![](images/proj_mgmt_team_science/mind-map.png){fig-alt="Bubble with a central concept or question, surrounded, at the first level, by inputs, outputs or modifiers and at the second level by question, concerns, or implications" width="90%" fig-align="center" .lightbox}
...
![](images/proj_mgmt_team_science/feasibility-matrix.png){fig-alt="x and y axes, labelled with novelty/importance (Y) and feasibility (x), with project ideas distributed across the resulting space" width="90%" fig-align="center" .lightbox}
...
![](images/proj_mgmt_team_science/gantt-image.png){fig-alt="a series of overlapping horizontal colored bars represents the active work periods for several critical project tasks" .lightbox}
...
![Kanban board example using GitHub Projects](images/proj_mgmt_team_science/github-project.png){fig-alt="a series of vertical boards labelled back burner, in queue, active progress, waiting, and done, with cards for specific tasks and individuals and due dates assigned" .lightbox}
...
![Gantt Chart Example using GitHub Projects](images/proj_mgmt_team_science/github-gantt.png){fig-alt="a series of overlapping horizontal colored bars represents the active work periods for several critical project tasks" .lightbox}
