...
![](images/proj_mgmt_team_science/feasibility-matrix.png){fig-alt="x and y axes, labeled with novelty/importance (Y) and feasibility (x), with project ideas distributed across the resulting space" width="90%" fig-align="center" .lightbox}
...
![Kanban board example using GitHub Projects](images/proj_mgmt_team_science/github-project.png){fig-alt="a series of vertical boards labeled back burner, in queue, active progress, waiting, and done, with cards for specific tasks and individuals and due dates assigned" .lightbox}
