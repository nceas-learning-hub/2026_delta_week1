...
[Full Screen](slides/github_introduction_positron/slides1_motivating_example.html)

```{=html}
<iframe class="slide-deck" src="slides/github_introduction_positron/slides1_motivating_example.html" style="border: 1px solid #2e3846;"></iframe>
```
...
<p align="center">
<img src="images/github_introduction_positron/github-test-clone-url.png" alt="Screen capture of the dropdown menu in GitHub that appears when you click the 'code' button" width="70%"/>
</p>
...
<p align="center">
<img src="images/github_introduction_positron/rstudio-clone-repo-sam.png" alt="Screen capture of RStudio's dialogue menu for cloning a new repository from GitHub" width="90%"/>
</p>
:::
...
<p align="center">
<img src="images/github_introduction_positron/github-rstudio-test-sam.png" alt="Screen capture of RStudio after successfully cloning a new repository from GitHub" width="100%"/>
</p>
...
<p align="center">
<img src="images/github_introduction_positron/rstudio-history-1-sam.png" alt="Screen capture of RStudio page showing the Git history of a local repository" width="100%"/>
</p>
...
<p align="center">
<img src="images/github_introduction_positron/rstudio-status-pane-sam.png" alt="Screen capture of RStudio diff/commit window where edits to the README are shown with new lines highlighted green" width="100%"/>
</p>
...
<img src="images/github_introduction_positron/rstudio-commit-1.png" alt="Screen capture of RStudio's diff/commit window where an edited README is staged (by checking the box next to the file's name) and a commit message has been entered into the respective window" width="100%"/>
...
<img src="images/github_introduction_positron/rstudio-commit-2.png" alt="Screen capture of RStudio's diff/commit window after a commit has been made and the .Rproj file has been staged with a commit message entered" width="100%"/>
...
<img src="images/github_introduction_positron/rstudio-history-3.png" alt="Screen capture of RStudio's Git history page showing four total commits (the initial one and three follow-up custom commits)" width="100%"/>
...
<img src="images/github_introduction_positron/github-history.png" alt="Screen capture of a GitHub repository's commit history showing four total commits (the initial one and three follow-up custom commits)" width="100%"/>
...
<img src="images/github_introduction_positron/use_git.png" alt="Screen capture of RStudio with the 'Git' pane circled in red and the '.gitignore' file in the 'Files' pane boxed by a red rectangle" width="100%"/>
...
<img src="images/github_introduction_positron/use_github.png" alt="Screen capture of a GitHub repository containing all of the files that were present in the previous screen capture of RStudio" width="100%"/>
...
<img src="images/github_introduction_positron/git_status_unstaged.png" alt="Screen capture of RStudio with a number of files in the 'Git' pane showing as untracked enclosed in a red rectangleand the command line code that initialized the Git repository also enclosed in a red rectangle" width="100%"/>
...
<img src="images/github_introduction_positron/git_status_staged.png" alt="Screen capture of RStudio with a number of files in the 'Git' pane staged to be committed enclosed in a red rectangle and the command line code that will make that commit also enclosed in a red rectangle" width="100%"/>
...
<img src="images/github_introduction_positron/setup-empty-repo.png" alt="Screen capture of an empty GitHub repository with helpful command line code for connecting an existing local Git repository with an empty GitHub repository" width="100%"/>
