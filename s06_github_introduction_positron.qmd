...
:::{.callout-important}
#### A Critical Caveat
There is a noteable exception to the above: <u>only when _all_ of the changed files are committed will the "Commit" button become a "Sync" button.</u> So, if you have edited several files but only commit the changes to one, you won't see the "Sync" button.

However, you can still sync your changes without needing to commit all changes to all your files! You just need to do the following:

1. Hover over the "Changes" heading <u>above the commit message field</u>.
2. Click the ellipsis (`...`)
3. Navigate to the **Pull, Push** option
4. Click **Sync**
