...
:::{.column-page}
<p align="center">
<img src="images/github_introduction/ss3sim-github.png" alt="Screen capture of a GitHub repository's landing page" width="100%"/>
</p>
:::
...
:::{.column-page}
<p align="center">
<img src="images/github_introduction/ss3sim-commits.png" alt="Screen capture of a GitHub repository's page showing the history of the commits in the repository" width="100%"/>
</p>
:::
...
:::{.column-page}
<p align="center">
<img src="images/github_introduction/ss3sim-diff.png" alt="Screen capture of a GitHub repository's page showing the 'diff' of files edited in a particular commit" width="100%"/>
</p>
:::
...
<p align="center">
<img src="images/github_introduction/new-repo-github.png" alt="Screen capture of the page on GitHub that allows a user to create a new repository" width="100%"/>
</p>
...
<img src="images/github_introduction/github-test-repo.png" alt="Screen capture of the main landing page for a brand new GitHub repository" width="100%"/>
...
<img src="images/github_introduction/github-test-edit.png" alt="Screen capture of the page in GitHub that appears when you edit a file in a repository directly through GitHub's web interface" width="100%"/>
...
<img src="images/github_introduction/github-test-displayed.png" alt="Screen capture of the landing page of a GitHub repository after the README has been edited to include non-template content" width="100%"/>
...
<p align="center">
<img src="images/github_introduction/github-test-clone-url.png" alt="Screen capture of the dropdown menu in GitHub that appears when you click the 'code' button" width="70%"/>
</p>
...
<p align="center">
<img src="images/github_introduction/rstudio-clone-repo-sam.png" alt="Screen capture of RStudio's dialogue menu for cloning a new repository from GitHub" width="90%"/>
</p>
:::
...
<p align="center">
<img src="images/github_introduction/github-rstudio-test-sam.png" alt="Screen capture of RStudio after successfully cloning a new repository from GitHub" width="100%"/>
</p>
...
<p align="center">
<img src="images/github_introduction/rstudio-history-1-sam.png" alt="Screen capture of RStudio page showing the Git history of a local repository" width="100%"/>
</p>
...
<p align="center">
<img src="images/github_introduction/rstudio-status-pane-sam.png" alt="Screen capture of RStudio diff/commit window where edits to the README are shown with new lines highlighted green" width="100%"/>
</p>
...
<img src="images/github_introduction/rstudio-commit-1.png" alt="Screen capture of RStudio's diff/commit window where an edited README is staged (by checking the box next to the file's name) and a commit message has been entered into the respective window" width="100%"/>
...
<img src="images/github_introduction/rstudio-commit-2.png" alt="Screen capture of RStudio's diff/commit window after a commit has been made and the .Rproj file has been staged with a commit message entered" width="100%"/>
...
it's a good indicator that you did not set your GitHub Personal Access Token (PAT) correctly. You can redo the steps outlined in the [GitHub Authentication section](https://nceas-learning-hub.github.io/2026_delta_week1/s02_git_setup.html#github-authentication) to (re)set your PAT, then **Push** again.
:::

<img src="images/github_introduction/rstudio-history-3.png" alt="Screen capture of RStudio's Git history page showing four total commits (the initial one and three follow-up custom commits)" width="100%"/>
...
<img src="images/github_introduction/github-history.png" alt="Screen capture of a GitHub repository's commit history showing four total commits (the initial one and three follow-up custom commits)" width="100%"/>
...
<img src="images/github_introduction/use_git.png" alt="Screen capture of RStudio with the 'Git' pane circled in red and the '.gitignore' file in the 'Files' pane boxed by a red rectangle" width="100%"/>
...
<img src="images/github_introduction/use_github.png" alt="Screen capture of a GitHub repository containing all of the files that were present in the previous screen capture of RStudio" width="100%"/>
...
<img src="images/github_introduction/git_status_unstaged.png" alt="Screen capture of RStudio with a number of files in the 'Git' pane showing as untracked enclosed in a red rectangleand the command line code that initialized the Git repository also enclosed in a red rectangle" width="100%"/>
...
<img src="images/github_introduction/git_status_staged.png" alt="Screen capture of RStudio with a number of files in the 'Git' pane staged to be committed enclosed in a red rectangle and the command line code that will make that commit also enclosed in a red rectangle" width="100%"/>
...
<img src="images/github_introduction/git_commit.png" alt="Screen capture of RStudio with the successful commit dialogue in the Terminal pane enclosed by a red rectangle with the message 'commit your files with an informative commit message' and some addiitonal metadata about the commit enclosed in a blue rectangle with the message 'use `git log` to see your commit history" width="100%"/>
...
<img src="images/github_introduction/setup-empty-repo.png" alt="Screen capture of an empty GitHub repository with helpful command line code for connecting an existing local Git repository with an empty GitHub repository" width="100%"/>
