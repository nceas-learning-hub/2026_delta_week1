...
![Adapted from [Faundeen et al., 2013](https://pubs.usgs.gov/of/2013/1265/pdf/of2013-1265.pdf) and DataONE](images/data_mgmt_discovery/data-workflow.png){fig-alt="Data workflow graphic with each stage following the next to form a pipeline" fig-align="center" .lightbox}
...
![](images/data_mgmt_discovery/box-new-app.png){fig-alt="Box new app interface" fig-align="center" width="80%"}

You should now see your application listed in the developer console.

![](images/data_mgmt_discovery/box-app-created.png){fig-alt="Box app listed in developer console" fig-align="center" width="80%"}
...
![](images/data_mgmt_discovery/box-redirect-uri.png){fig-alt="Box configuration section for redirect URI" fig-align="center" width="80%"}
...
![](images/data_mgmt_discovery/box-credentials.png){fig-alt="Box configuration section for redirect URI" fig-align="center" width="80%"}
:::
...
> as.data.frame(response)[c("name", "type", "size", "id")]
#      name type size            id
#  iris.csv file 3716 2188497409481
```
...
```r
# Read iris.csv into R as a data frame
...
> iris_from_box <- box_read_csv(2188497409481, stringsAsFactors=TRUE)

> identical(iris, iris_from_box)
# [1] TRUE
```
