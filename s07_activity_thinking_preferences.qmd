...
![](images/thinking_preferences/agreement-alignment.png){fig-alt="Figure of two right-facing arrows filled with smaller arrows. The small arrows filling the large 'agreement' arrow mostly face right but there is a lot of variation. The small arrows filling the large 'alignment' arrow all face the same way as the larger arrow" width="50%" fig-align="center"}
...
![](images/thinking_preferences/meeting-design-questions.png){fig-alt="Figure separating meeting planning into 'why, what, how, and who' facets" width="100%" .lightbox}
...
![](images/thinking_preferences/project-impact-vs-feasibility.png){fig-alt="Graph of impact versus feasibility where both axes range from low to high and the plot area is divided into four equal sections" width="70%" fig-align="center" .lightbox}
