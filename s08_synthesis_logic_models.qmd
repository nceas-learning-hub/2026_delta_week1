...
![](images/synthesis_logic_models/LM1.png){fig-alt="A diagram of three boxes lined horizontally, labeled 'inputs,' 'outputs,' and 'outcomes' from left to right" width="70%" fig-align="center"}
...
![](images/synthesis_logic_models/LM2.png){fig-alt="The three-box model above is expanded to include resources under inputs, activities and participants under outputs, and short, medium, long term under outcomes." width="70%" fig-align="center"}
...
![](images/synthesis_logic_models/LM3.png){fig-alt="The figure above is modified to include grey arrows pointing right to left between each box, with each box labeled 'if' and each arrow labeled 'then', for example IF resource condition is met THEN activities can result, IF activities THEN participants, etc" width="70%" fig-align="center"}
...
![](images/synthesis_logic_models/LM5.png){fig-alt="Multiple boxes, each representing an input, an output, or an outcome, are connected by grey arrows flowing mostly left-to-right but some are bi-directional or indicate loops back to previous steps" width="70%" fig-align="center"}
...
## Breakout: Synthesis Planning

Breakout groups will focus on refining ideas for synthesis topics using the logic modeling tools described in this section. The goal for this session is to develop one or more high-level logic models that:
...
- Powerpoint [logic model template](images/synthesis_logic_models/logic_model_template.pptx)
    * [Logic model template on Google Drive](https://docs.google.com/presentation/d/1MBUy35QIAkA5FNCdRzWJM2aPaFXfUmGl/edit?usp=sharing&ouid=113328660159760492310&rtpof=true&sd=true){.external target="_blank"}
- [Mermaid flowcharts](https://mermaid.js.org/syntax/flowchart.html){.external target="_blank"} embedded in [Quarto documents](https://quarto.org/docs/authoring/diagrams.html#mermaid){.external target="_blank"}

#### Mermaid example

Here is a simple example of a logic model flow chart for a hypothetical synthesis project, created using Mermaid, a tool for creating diagrams and flowcharts using text-based syntax.
...
-   Powerpoint [logic model template](images/synthesis_logic_models/logic_model_template.pptx)
    * [Same template on Google Drive](https://docs.google.com/presentation/d/1MBUy35QIAkA5FNCdRzWJM2aPaFXfUmGl/edit?usp=sharing&ouid=113328660159760492310&rtpof=true&sd=true){.external target="_blank"}
