...
In breakout groups, focus on refining ideas for synthesis topics using the logic modeling tools described in this section. The goal for this session is to develop one or more high-level logic models that:
...
The tools in the following section may be helpful for this exercise, but feel free to use any tools that work for your group. 
:::
