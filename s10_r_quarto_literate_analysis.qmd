...
Create a new code chunk under "Read in data" (and give it a helpful name!).  Use `read_csv()` to load your data.  Both RStudio and Positron will set your working directory to the project root, so you can (and should!) use a relative path to your data file.
