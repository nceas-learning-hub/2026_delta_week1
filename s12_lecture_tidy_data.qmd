...
There are also other types of keys, like a _natural key_ or a _surrogate key_.  Each type of key has advantages and disadvantages.  You can read more about this in [this article](https://www.databasestar.com/database-keys/){.external target="_blank" rel="noopener"}.
