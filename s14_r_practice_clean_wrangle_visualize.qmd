...
```r
lobster_abundance <- readr::read_csv(file.path("data", "Lobster_Abundance_All_Years_20240411.csv")) %>%
    janitor::clean_names()
```
...
```r
lobster_traps <- readr::read_csv(file.path("data", "Lobster_Trap_Counts_All_Years_20210519.csv"))
    janitor::clean_names()
```
